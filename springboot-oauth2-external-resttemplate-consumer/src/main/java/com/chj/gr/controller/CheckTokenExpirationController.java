...
@RestController
@RequestMapping("/call/check/token/active")
public class CheckTokenExpirationController {
	...
	public boolean withAuthServerIntrospectionUri(String accessToken, String clientId, String clientSecret, String scopes) {
